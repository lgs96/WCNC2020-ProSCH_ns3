...
{
	std::string filename = "/home/test_user/myns3_2/src/mmwave/model/BeamFormingMatrix/SmallScaleFading.txt";
...
{
	std::string filename = "/home/test_user/myns3_2/src/mmwave/model/BeamFormingMatrix/TxAntenna.txt";
...
{
	std::string filename = "/home/test_user/myns3_2/src/mmwave/model/BeamFormingMatrix/RxAntenna.txt";
...
{
	std::string filename = "/home/test_user/myns3_2/src/mmwave/model/BeamFormingMatrix/TxSpatialSigniture.txt";
...
{
	std::string strFilename = "/home/test_user/myns3_2/src/mmwave/model/BeamFormingMatrix/RxSpatialSigniture.txt";
