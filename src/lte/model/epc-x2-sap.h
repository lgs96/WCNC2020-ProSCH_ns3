...
public:
  ...
  //Process3
  virtual void GetEndMarker (UeDataParams params) = 0;
};
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendEndMarker(EndMarkerParams params)
{
...
template <class C>
void
EpcX2PdcpSpecificProvider<C>::SendEndMarker(UeDataParams params)
{
  m_x2->DoSendEndMarker(params);
}
...
public:
  ...
  //Process3
  virtual void GetEndMarker (UeDataParams params);
...
//Process3: Send end marker to target cell's RLC layer -> Process4: Now it sends uedataparams
template <class C>
void
